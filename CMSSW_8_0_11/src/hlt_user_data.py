# /users/aavkhadi/hbb_initial/dijetBTag_Landsberg/V1 (CMSSW_8_0_10)
...
#process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, [...], process.HLTAnalyzerEndpath, process.HLTBitAnalysisEndpath ))

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/aavkhadi/hbb_initial/dijetBTag_Landsberg/V1')
)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_DiPFJetAve80_v3, process.HLT_PFJet80_v5, process.HLT_DoubleJetsC100_DoubleBTagCSV_p014_DoublePFJetsC100MaxDeta1p6_v2, process.HLT_DoubleJetsC100_DoubleBTagCSV_p026_DoublePFJetsC160_v2, process.HLTBitAnalysisFinalpath ,process.HLTBitAnalysisEndpath ))
...
process = L1XML(process,"L1Menu_Collisions2016_v2.xml")
