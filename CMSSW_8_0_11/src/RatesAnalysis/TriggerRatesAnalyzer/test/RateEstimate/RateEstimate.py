...
if len(sys.argv) < 3:
    print "usage:"
    print "python RateEstimate.py nLS lenLS psNorm"
...
nLS = int(sys.argv[2]) ## number of Lumi Sections run over data
lenLS = int(sys.argv[3]) ## length of Lumi Section
psNorm = int(sys.argv[4]) #232./4. # Prescale Normalization factor if running on HLTPhysics
